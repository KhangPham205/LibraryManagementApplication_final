        ...
        private void ExportFile()
        {
            ...
            try
            {
                ...
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    p.Workbook.Worksheets.Add("Nhà Xuất Bản");
                    // lấy sheet vừa add ra để thao tác
                    ExcelWorksheet ws = p.Workbook.Worksheets["Nhà Xuất Bản"];
                    if (ws == null)
                    {
                        EXMessagebox.Show("Không thể thêm worksheet.");
                        return;
                    }
                    ws.Name = "Nhà Xuất Bản";
                    ...
                    ws.Cells[3, 1].Value = "Thống kê thông tin Nhà Xuất Bản";
                    ...
                    List<NhaXuatBan> ExcelList = nxb.ItemsSource.Cast<NhaXuatBan>().ToList();
                    if (nxb.ItemsSource == null)
                    {
                    ...
                    foreach (var item in ExcelList)
                    {
                        ...
                        ws.Cells[rowIndex, colIndex++].Value = item.MaNXB;
